function scopeMainBanner($scope){
		iniciarBanner(); 		
}
...
function iniciarBanner(){
	...
	useJs('head', 'view/modulos/site/js/banner/jssor.js');
	useJs('head', 'view/modulos/site/js/banner/jssor.slider.js');
