...
*/
      ...
      /**
       * função responsável por para o bloqueio da tela.
       */
      function pararBloqueio(){
    	  
      	document.body.style.cursor='default';
    	  
    	$('#block-ui').removeClass('block-ui');
    	
    	$('#block-ui').removeClass('navbar-fixed-top');
...
*/
      ...
      /**
       * função responsável por bloquear a tela.
       */
      function bloquearTela(){
    	  
       	document.body.style.cursor='wait';
    	  
    	$('#block-ui').addClass('block-ui');
    	
    	$('#block-ui').addClass('navbar-fixed-top');
