...
$(function() {
    ...
    /* E-mail message */
    var mailMsg = "O e-mail informado &eacute; inválido!";
    /* CPF message */
    ...
    /* maxlength message */
    var maxMsg = "A quantidade máxima &eacute; de X caracters!";
    /* Password message */
    ...
    /* mascaras */
    $('body').append('<script src="inc_library/validates-forms/js/jquery.mask.js" type="text/javascript"></script>');
    /* mascara data */
